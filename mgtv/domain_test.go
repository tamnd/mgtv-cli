...
// HTTP behaviour is covered in mgtv_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "mgtv://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("mgtv", "about")
	if err != nil || got.String() != "mgtv://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want mgtv://page/about", got.String(), err)
	}
}
